	...
	factory: (require) => {
		...
		function TreeAction(props) {
			...
			var renderNode = function (entry, depth) {
				...
				if (entry.type === "dir") {
					...
					return jsxs("li", { className: "extc-tnode", children: [
						...
						isOpen ? (kids ? (kids.length === 0 ? jsx("div", { className: "extc-tempty", children: t("treeEmpty") }) : jsx("ul", { className: "extc-tlist", children: kids.map(function (kid) { return renderNode(kid, depth + 1); }) })) : (failed ? jsx("div", { className: "extc-terr", children: failed }) : null)) : null
					] }, entry.path);
				}
				return jsxs("li", { className: "extc-tnode", children: [
					jsx("button", {
						...
						style: indent,
						title: entry.path,
						onClick: function () { copyPath(entry.path); },
						children: [
			...
			return jsxs("div", { className: "extc-tlayer", children: [
				open ? jsxs("section", { className: "extc-tpanel", "aria-label": t("treePanelTitle"), children: [
					...
					jsx("div", { className: "extc-tbody", children: error ? jsxs("div", { className: "extc-terr", children: [t("treeError"), error, jsx("button", { type: "button", className: "extc-tretry", onClick: refresh, children: t("treeRetry") })] }) : root === null ? jsx("p", { className: "extc-tnote", children: t("treeLoading") }) : jsx("ul", { className: "extc-tlist", children: root.entries.map(function (entry) { return renderNode(entry, 0); }) }) })
				] }) : null,
