window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			visionMaxImagesHint: "1-8；超出部分以占位文本代替",
		...
		var en = {
			...
			visionMaxImagesHint: "1-8; extra images become placeholder text",
		...
		function SettingsTab(props) {
			...
			var save = useCallback(function () {
				...
				var visionDraft = {
					...
					maxImages: draft.visionMaxImages.trim() === "" ? 4 : Math.min(Math.max(parseInt(draft.visionMaxImages, 10) || 4, 1), 8)
				};
			...
			return jsxs("div", { className: "extc-panel", children: [
				...
				jsxs("div", { className: "extc-card", children: [
					...
					!ready || draft === null ? null : jsxs("div", { className: "extc-form", children: [
						...
						jsx(Field, { label: t("visionMaxImages"), hint: t("visionMaxImagesHint"), children: jsx(TextInput, { value: draft.visionMaxImages, disabled: !writable || busy, onChange: function (value) { setDraft(Object.assign({}, draft, { visionMaxImages: value })); } }) }),
