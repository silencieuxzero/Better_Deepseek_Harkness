window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			treeCopied: "已复制路径",
			treeRoot: "文件树根目录",
			treeRootHint: "侧栏文件树浏览的根目录；留空使用工作目录（进程 cwd）。",
		...
		var en = {
			...
			treeRootHint: "Root directory browsed by the sidebar file tree; leave empty for the workspace (process cwd).",
