window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function TerminalTab(props) {
			...
			return jsxs("div", { className: "extc-term", children: [
				jsxs("div", { className: "extc-term-main", children: [
					error ? jsx("div", { className: "extc-error", children: error }) : null,
					active ? jsxs(Fragment, { children: [
						jsxs("div", { className: "extc-term-head", children: [
							jsx("span", { className: "extc-term-title", children: t("tabTerminals") + " · " + active.kind + (active.alive === false ? " (" + t("termExited") + ")" : " · " + t("termRunning")) }),
					...
					] }) : jsx("p", { className: "extc-empty", children: t("termEmpty") })
				] }),
				jsxs("div", { className: "extc-term-side", children: [
					jsx("h4", { className: "extc-card-title", children: t("termNew") }),
					atCap ? jsx("p", { className: "extc-empty", children: t("termCap") }) : null,
					jsxs("div", { className: "extc-actions", children: [
						jsx(Button, { small: true, primary: true, busy: busy === "cmd", disabled: busy !== null || atCap, onClick: function () { createTerm("cmd"); }, children: t("termCmd") }),
						jsx(Button, { small: true, primary: true, busy: busy === "powershell", disabled: busy !== null || atCap, onClick: function () { createTerm("powershell"); }, children: t("termPowerShell") })
					] }),
					jsx("ul", { className: "extc-term-list", children: terminals.map(function (term, index) {
						return jsxs("li", { className: "extc-term-item" + (term.id === activeId ? " extc-term-active" : ""), children: [
							jsx("button", { type: "button", className: "extc-term-sel", onClick: function () { switchTo(term.id); }, children: [
								jsx("span", { className: "extc-term-kind", children: term.kind === "powershell" ? "PS" : "CMD" }),
								jsx("span", { className: "extc-term-name", children: t("tabTerminals") + " " + (index + 1) }),
								jsx("span", { className: "extc-term-state" + (term.alive === false ? " extc-term-dead" : ""), children: term.alive === false ? t("termExited") : t("termRunning") })
							] }),
							jsx("button", { type: "button", className: "extc-term-close", title: t("termKill"), "aria-label": t("termKill"), onClick: function () { killTerm(term.id); }, children: jsx(_primitives.IconCloseOutline16, { size: 12 }) })
						] }, term.id);
					})) })
			] })
		] });
		...
		function ExtensionCenterSection(props) {
			...
			var tabs = [
				...
				{ id: "terminals", label: t("tabTerminals") },
			...
			return jsxs("div", { className: "extc", children: [
				...
				tab === "terminals" ? jsx(TerminalTab, { t: t }) : null,
